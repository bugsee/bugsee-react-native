...
let package = Package(
  ...
  // 15.0 is React Native's floor. This target consumes React-GeneratedCode,
  // whose manifest declares .iOS(.v15), and SwiftPM refuses the graph rather
  // than resolve it: "The package product 'X' requires minimum platform
  // version 15.0 for the iOS platform, but this target supports 13.0".
  // Reproduced; do not lower it.
  platforms: [.iOS(.v15)],
  products: [
